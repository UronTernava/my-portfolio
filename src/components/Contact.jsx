  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await emailjs.send(
        'service_hs3s2pq', // Your EmailJS service ID
        'template_ovg1zzu', // Your EmailJS template ID
        {
          to_email: 'uronternava1@gmail.com',
          from_name: formData.name,
          from_email: formData.email,
          subject: formData.subject,
          message: formData.message,
        },
        'n5nwkRzDTvnqcy8x1' // Replace with your EmailJS public key
      )
  ...
  const contactInfo = [
    {
      ...
      title: 'Phone',
      value: 'viber +38345848061 whatsapp +38345848061'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Email',
      value: 'uronternava1@gmail.com',
      link: 'mailto:uronternava1@gmail.com'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Location',
      value: 'Fushe Kosove',
      link: 'https://www.google.com/maps/place/Kosovo+Polje/@42.6377539,21.0702684,14z/data=!3m1!4b1!4m6!3m5!1s0x135362077e49168b:0xe36405bd335d8f0!8m2!3d42.6374125!4d21.0929118!16zL20vMDFwc2Jr?entry=ttu&g_ep=EgoyMDI1MDYxNy4wIKXMDSoASAFQAw%3D%3D'
    }
  ]
