    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="space-y-8 reveal-on-scroll-left">
            ...
            <p className="text-lg text-gray-300 leading-relaxed max-w-lg reveal-on-scroll">
            ...
            {/* Social Links */}
            <div className="flex space-x-6 reveal-on-scroll">
              {[
          ...
          <div className="flex justify-center lg:justify-end reveal-on-scroll-right">
